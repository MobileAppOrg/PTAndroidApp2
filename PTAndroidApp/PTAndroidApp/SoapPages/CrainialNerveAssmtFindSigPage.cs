...
{
	public class CrainialNerveAssmtFindSigPage : ContentPage
	{
		public CrainialNerveAssmtFindSigPage ()
		{
		...
		static TableView CreateTable()
		{
			...
			Findings.SetBinding (Editor.TextProperty, "CranialNerveAssmtFindings", BindingMode.TwoWay);
			Significance.SetBinding (Editor.TextProperty, "CranialNerveAssmtSignificance", BindingMode.TwoWay);
			...
			{	HasUnevenRows = true,
				...
				Root =  new TableRoot ()
				{
					new TableSection ("Cranial Nerve Assessment Findings and Significance")
					{
