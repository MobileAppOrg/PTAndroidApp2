...
{
	public class PulmonaryAssmt3 : ContentPage
	{
		public PulmonaryAssmt3 ()
		{
		...
		{
			var lblAxilla = new Label { Text="LANDMARK: XIPHOID PROCESS", FontAttributes = FontAttributes.Bold, HorizontalOptions = LayoutOptions.FillAndExpand, YAlign = TextAlignment.Center};
			...
			MaxInsT1.SetBinding (Entry.TextProperty, "CMXiphoid.MaxInsT1");
			...
			MaxInsT2.SetBinding (Entry.TextProperty, "CMXiphoid.MaxInsT2");
			...
			MaxInsT3.SetBinding (Entry.TextProperty, "CMXiphoid.MaxInsT3");
			...
			MaxInsAve.SetBinding (Entry.TextProperty, "CMXiphoid.MaxInsAve");
			...
			MaxExpT1.SetBinding (Entry.TextProperty, "CMXiphoid.MaxExpT1");
			...
			MaxExpT2.SetBinding (Entry.TextProperty, "CMXiphoid.MaxExpT2");
			...
			MaxExpAve.SetBinding (Entry.TextProperty, "CMXiphoid.MaxExpAve");
			...
			DiffT1.SetBinding (Entry.TextProperty, "CMXiphoid.DiffT1");
			...
			DiffT2.SetBinding (Entry.TextProperty, "CMXiphoid.DiffT2");
			...
			DiffT3.SetBinding (Entry.TextProperty, "CMXiphoid.DiffT3");
			...
			DiffAve.SetBinding (Entry.TextProperty, "CMXiphoid.DiffAve");

			return new TableView () {
				Intent = TableIntent.Form,
				Root = new TableRoot () {
					new TableSection ("Pulmonary Assessment - Part 3") {
						new ViewCell {
