...
{
	public class MMTFindSigPage : ContentPage
	{
		public MMTFindSigPage ()
		{
		...
		static TableView CreateTable()
		{
			...
			Findings.SetBinding (Editor.TextProperty, "MmtFindings", BindingMode.TwoWay);
			Significance.SetBinding (Editor.TextProperty, "MmtSignificance", BindingMode.TwoWay);
			...
			{	HasUnevenRows = true,
				...
				Root =  new TableRoot ()
				{
					new TableSection ("MMT Findings and Significance")
					{
